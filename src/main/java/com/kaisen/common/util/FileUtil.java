...
public class FileUtil {
	...
	public static int batchCopy(List<String> sourceList, String dstdir,
			boolean overwrite) {
	...
	public static int batchCopy(List<String> fileList, String sourceDir,
			String dstDir, boolean overwrite) {
		int copySum = 0;
	 ...
	 * 
	 * @param directory
	 *            Be want to be compressed directory.
	 * @param zipFile
	 *            Be appointed file which ZIP compressed.
	 * @return from parameter of zipFile.
	 * @throws IOException
	 */
	public static File createZipFile(File directory, File zipFile)
			throws IOException {
	...
	/**
	 * @see #createZipFile(new File(directory),new File(zipFileNameNoSuffix +
	 *      ".zip"))
	 */
	public static File createZipFile(String directory,
			String zipFileNameNoSuffix) throws IOException {
		return createZipFile(new File(directory), new File(zipFileNameNoSuffix
				+ ".zip"));
	}
	...
	public static String getNameNoSuffix(File file) {
		...
		return (indexSuffixFlag == -1) ? fileName : fileName.substring(0,
				indexSuffixFlag);
	}
	...
	private static void put(File f, ZipOutputStream out, String dir)
			throws IOException {
		if (f.isDirectory()) {
