...
public class WriterUtil {
    ...
    public static void write(File fileName, byte[] bytes) {
        ...
        try {
            ...
            logger.error("Method write(" + fileName + ",byte[] ...", e);
        }
        finally {
            if (fos != null) {
                try {
    ...
    public static void writeFile(File file, String content, String charsetName, boolean append) {
        ...
        try {
            ...
            logger.error("WriterFile writeFile(" + file + ") error!", e);
        }
        finally {
            try {
                if (out != null) {
                ...
                logger.error("WriterFile writeHtml(" + file + ") error!", e);
            }
        }
    }
    ...
    // bw.write(content);
    //
    // logger.debug("WriterFile writeFile("+file+","+content+")");
    //
    // } catch (Exception e) {
    // logger.error("WriterFile writeHtml("+file+") error!",e);
    // }finally{
